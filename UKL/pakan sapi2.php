...
<body>
    <!-- navbar start -->
    <nav class="navbar">
        <a href="index2.html" class="navbar-logo"><img src="sahabat-high-resolution-logo-transparent.png" alt=""></a>
          ...
          <div class="container">
            ...
            <div class="product-list">
              ...
              <img src="kemasan pakan.jpeg" class="pakan">
                <h3>SUPER++</h3>
                <p>Pakan Untuk Penggemukan Sapi</p>
                <button><a href="#">Beli</a></button>
              </div>
              <div class="product-item">
              <img src="kemasan pakan.jpeg" class="pakan">
                <h3>SUPER+</h3>
                <p>Pakan Sapi Untuk Menghasilkan Susu Yang Sempurna</p>
                <button><a href="#">Beli</a></button>
              </div>
              <div class="product-item">
              <img src="kemasan pakan.jpeg" class="pakan">
