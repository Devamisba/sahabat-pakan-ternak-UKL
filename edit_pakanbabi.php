...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM pakanbabi WHERE id_babi = $id";
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE pakanbabi SET foto='$foto', nama='$nama', deskripsi='$deskripsi', harga_perkilo='$harga_perkilo' WHERE id_babi=$id";
...
<html>
<head>
    <title>Update Pakan Babi</title>
</head>
<body>
    <h2>Update Pakan Babi</h2>
