<?php
    ...
    if(isset($_POST["tambah_barang"])) {
        ...
        $sql = "INSERT INTO pakanbabi (id_ayam, foto, nama, deskripsi, harga_perkilo) VALUES ('','$foto','$nama','$deskripsi', '$harga_perkilo')";

        if($mysqli->query($sql)) {
        header("Location: tabel_pakanbabi.php");
        }else {
